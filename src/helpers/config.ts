...
const ConfigSchema = z.object({
  ...
  VITE_FETCH_BASE_URL: z.string(),
  VITE_FETCH_GET_MATCHES_URL: z.string(),
  VITE_FETCH_GET_ALL_COMPETITIONS_URL: z.string(),
  VITE_FETCH_GET_STANDING_URL: z.string(),
  VITE_FETCH_GET_COMPETITION_URL: z.string(),
